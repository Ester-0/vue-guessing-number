...
/**
 * 1. Asignar un escuchados de eventos al botómn, para que al hacer click ejecute la función startGame
 ...
 * 3. Mostrar en la parte adecuada del <template> todos los números que ya ha probado el usaurio. NO hace falta computed properties (podríais usarla), simplemente usad la notación mostacho {{ }} para mostrar la variable previousGuessses
 * 
 * Coregir: 13:50
 */
